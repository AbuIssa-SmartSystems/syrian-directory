...
<body>
    ...
    <div class="container py-5">
        <div class="text-center mb-5">
            ...
            <div class="mt-3">
                <a href="<?php echo e(url('/submit')); ?>" class="btn btn-success rounded-pill px-4 me-2"><i
                        class="fa-solid fa-plus me-1"></i> Suggest Portal</a>
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-outline-light rounded-pill px-4">Dashboard</a>
                <?php else: ?>
                    <a href="<?php echo e(url('/login')); ?>" class="btn btn-outline-light rounded-pill px-4">Login</a>
                <?php endif; ?>
            </div>
        </div>
                    ...
                    <div class="glass-card p-4 h-d-flex flex-column justify-content-between">
                        <div>
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span
                                    class="badge bg-success bg-opacity-10 text-success border border-success border-opacity-25 px-3 py-2 rounded-pill"><?php echo e($entity->category_name); ?></span>
                                <span class="small text-muted"><i
                                        class="fa-solid fa-location-dot me-1 text-danger"></i><?php echo e($entity->governorate); ?></span>
                            </div>
                            <h4 class="fw-bold mb-2"><?php echo e($entity->entity_name); ?></h4>
                            <p class="opacity-75 small mb-3"><?php echo e($entity->description ?? 'No description provided.'); ?>
...
<?php /**PATH C:\xampp\htdocs\syrian-directory\resources\views/directory.blade.php ENDPATH**/ ?>