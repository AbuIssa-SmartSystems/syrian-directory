...
<body>
    ...
    <nav class="navbar navbar-sticky d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
            ...
            <a class="navbar-brand fw-bold text-success m-0" href="<?php echo e(url('/dashboard')); ?>">
        ...
        <div class="d-none d-md-flex flex-grow-1 mx-4 max-w-50">
            <form action="<?php echo e(url('/dashboard')); ?>" method="GET" class="input-group">
                <input type="text" name="search" class="form-control border-end-0"
                    placeholder="Search official portals..." value="<?php echo e(request('search')); ?>">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="dropdown">
                <button
                    ...
                    <i class="fa-solid fa-user-shield text-success me-1"></i> <?php echo e(Auth::user()->name); ?>

                </button>
                <ul class="dropdown-menu dropdown-menu-end glass-card border-secondary mt-2">
                    <li><a class="dropdown-item text-light small" href="<?php echo e(url('/admin/submissions')); ?>"><i
        ...
        <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        ...
                        <div class="d-flex gap-3">
                            <a href="<?php echo e(url('/admin/submissions')); ?>" class="btn btn-neon px-4 py-2 rounded-pill">
                                <i class="fa-solid fa-clipboard-list me-2"></i> Review Submissions
                            </a>
                            <a href="<?php echo e(url('/submit')); ?>" class="btn px-4 py-2 rounded-pill"
            ...
            <div class="row g-4" id="entitiesGrid">
                <?php $__empty_1 = true; $__currentLoopData = $entities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-md-4 entity-card" data-governorate="<?php echo e($entity->governorate); ?>"
                        data-category="<?php echo e($entity->category_name); ?>">
                        <div class="glass-card p-4 d-flex flex-column justify-content-between h-100">
                            <div>
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span
                                        class="badge bg-success bg-opacity-10 text-success"><?php echo e($entity->category_name); ?></span>
                                    <small class="text-muted"><i class="fa-solid fa-map-pin me-1"></i>
                                        <?php echo e($entity->governorate); ?></small>
                                </div>
                                <h5 class="fw-bold mb-2"><?php echo e($entity->entity_name); ?></h5>
                                <p class="small opacity-75 mb-3"><?php echo e($entity->description); ?></p>
                            </div>

                            <div>
                                <!-- زر Visit Portal يأخذ كل كرت إلى رابطه الحقيقي الخاص به حصراً -->
                                <a href="<?php echo e($entity->official_url); ?>" target="_blank"
                                ...
                                <div
                                    ...
                                    <span class="small text-muted">
                                        Rating: <strong
                                            class="text-warning"><?php echo e(number_format($entity->averageRating(), 1)); ?></strong>
                                        <small>(<?php echo e($entity->ratings()->count()); ?>)</small>
                                    </span>

                                    <form action="<?php echo e(route('entities.rate', $entity->id)); ?>" method="POST"
                                        class="d-flex align-items-center gap-1">
                                        <?php echo csrf_field(); ?>
                                        <div class="star-rating d-flex gap-1">
                                            <?php for($i = 1; $i <= 5; $i++): ?>
                                                <button type="submit" name="rating" value="<?php echo e($i); ?>"
                                                    class="btn btn-link p-0 text-warning text-decoration-none"
                                                    title="Rate <?php echo e($i); ?> Stars">
...
<?php /**PATH C:\xampp\htdocs\syrian-directory\resources\views/dashboard.blade.php ENDPATH**/ ?>