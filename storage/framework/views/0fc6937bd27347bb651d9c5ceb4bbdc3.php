...
<head>
    ...
    <title>Login - Syrian Directory</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="col-md-5">
            ...
            <div class="glass-card p-4 p-md-5">
                <div class="text-center mb-4">
                    <div class="mb-3 text-success fs-1"><i class="fa-solid fa-landmark"></i></div>
                    <h3 class="fw-bold">Welcome Back</h3>
                    <p class="opacity-75 small">Sign in to access Syrian Directory</p>
                </div>
                ...
                <div class="text-center mt-3">
                    <span class="opacity-75 small">Don't have an account?</span>
                    <a href="<?php echo e(url('/register')); ?>" class="small fw-semibold ms-1">Register here</a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\syrian-directory\resources\views/login.blade.php ENDPATH**/ ?>